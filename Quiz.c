...
void Mix(){
	...
	printf("\nB) Central Power Unit - Unidade de For�a Central");
	...
	//questao 2 - facil
	printf("*--------------------------------*\n|  Pergunta %d   - Nivel Facil  |\n*--------------------------------*\nQuais s�o as principais fabricantes de processadores para Desktops e notebooks? \n----------------------------------", contp4++);
	printf("\nA) Intel e Dell");
	printf("\nB) Dell e AMD");
	printf("\nC) Intel e AMD");
	printf("\nD) AMD e IBM");
	...
	//questao 3 - facil
	printf("*--------------------------------*\n|  Pergunta %d   - Nivel Facil  |\n*--------------------------------*\nQuais s�o os sintomas mais comuns de superaquecimento do processador ? \n----------------------------------", contp4++);
	...
	//questao 7 - facil
	printf("*--------------------------------*\n|  Pergunta %d   - Nivel Facil  |\n*--------------------------------*\nO formato padrao dos arquivos gerados pelo Word �: \n----------------------------------", contp4++);
	printf("\nA) txt");
	printf("\nB) doc");
	printf("\nC) xls");
	printf("\nD) html");
	...
	//questao 8 - facil
	printf("*--------------------------------*\n|  Pergunta %d   - Nivel Facil  |\n*--------------------------------*\nA extensao padrao de arquivos de audio no windows �: \n----------------------------------", contp4++);
	printf("\nA) WAV");
	printf("\nB) BIN");
	printf("\nC) ARC");
	printf("\nD) WMF");
	...
	system("cls");
		...
		//questao 10 - facil
	printf("*--------------------------------*\n|  Pergunta %d   - Nivel Facil  |\n*--------------------------------*\n� um tipo de computador que tem como funcao controlar as demais estacoes de trabalho quando ligados em uma rede de computadores: \n----------------------------------", contp4++);
	...
	printf("\nA) Unidade Central de Processamento e Mem�ria de Massa.");
	printf("\nB) Dispositivos ou Unidades de Entrada.");
	printf("\nC) Unidade Central de Processamento e Memoria Principal.");
	printf("\nD) Unidade de Controle e Unidade de L�gica e Aritmetica.");
	printf("\n---------------------------------- \n");
	scanf("%s", &resp);
	...
	//questao 4 - dificil
	printf("*--------------------------------*\n|  Pergunta %d   - Nivel Dificil  |\n*--------------------------------*\nQuais s�o as principais fabricantes de processadores ARM ? \n----------------------------------", contp4++);
	...
	printf("\nD) � um tipo de memoria nao volatil");
	printf("\n---------------------------------- \n");
	scanf("%s", &resp);
	...
	//questao 7 - dificil
	printf("*--------------------------------*\n|  Pergunta %d   - Nivel Dificil  |\n*--------------------------------*\nA tecnica em que parte do programa � armazenada em disco e levada para a memoria para serexecutada quando necessario � chamada de: \n----------------------------------", contp4++);
	printf("\nA) armazenamento virtual");
	printf("\nB) aloca��o de memoria");
	printf("\nC) priorizacao de memoria");
	printf("\nD) aloca��o de recursos");
	printf("\n---------------------------------- \n");
	scanf("%s", &resp);
	...
	printf("\nC) o BIOS e a mem�ria RAM");
	printf("\nD) o chipset e a placa-m�e");
	printf("\n---------------------------------- \n");
	scanf("%s", &resp);
	...
	//questao 9 - dificil
	printf("*--------------------------------*\n|  Pergunta %d   - Nivel Dificil  |\n*--------------------------------*\nEm relacao as topologias de redes, � correto afirmar que: \n----------------------------------", contp4++);
...
void Info(){
	...
	printf("--------------------\n\tMenu5\n--------------------");
	printf("\n\n   INSTRU��ES  \n\n Este � um divertido jogo de perguntas e respostas. O jogador dever� escolher, dentre as 4 alternativas (A, B, C, D), apenas uma e em seguida pressionar enter. O jogo lhe informa se voc� acertou ou errou a quest�o.\n");
	printf("\n O jogo possui 3 n�veis de dificuldade: F�CIL, M�DIO e DIF�CIL\n MODO MIX: Neste modo, voc� jogar� o game completo, com as perguntas de todas as dificuldades. Os n�veis podem ser jogados de forma individual sem precisar jogar o game completo.");
	printf("\n\n   Sistema de pontuacao do game. \n\nN�vel facil   - Cada resposta certa valer� 150 pontos\nN�vel m�dio   - Cada resposta certa valer� 200 pontos\nNivel dif�cil - Cada resposta certa valer� 250 pontos\nModo Mix - Cada resposta certa valer� 250 pontos\n\nBasicamente � isso, divirta-se! ;D\n\n");
...
void Desv(){
	...
	printf("--------------------\n\tMenu6\n--------------------");
	printf("\n\nPROGRAMADORES: \n-Ana Carolina Vargas Bianchini Gaspar\n-Land William Abreu Pereira\n-Lucas Amorim de Souza\n\n");
